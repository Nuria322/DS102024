...
# los %% son funciones mágicas

import pytest
import pandas as pd

@pytest.fixture # Los @ son decoradores (función envoltoria, van funciones dentro de otras) en este caso la df_ventas está dentro de la pytest.fixture
def df_ventas():
